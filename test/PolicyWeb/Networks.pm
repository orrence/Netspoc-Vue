...
sub test_networks_grid {
    ...
    my $table = $browser->find_element('//div[@id="table_networks"]//div[@class="tabulator"]');
    ok($table, 'Found grid network');
    my @cells = $browser->find_child_elements($table, './/div[@class="tabulator-cell"]');
    ...
    ok($browser->download($browser->find_element('//div[@id="table_networks"]//span[@class="material-icons" and text()="picture_as_pdf"]'), /\.pdf$/), 'Download network pdf');
    ok($browser->download($browser->find_element('//div[@id="table_networks"]//span[@class="material-icons" and text()="border_all"]'), /\.xlsx$/), 'Download network xlsx');
}
...
sub test_ressources_grid {
    ...
    my $table = $browser->find_element('//div[@id="table_networks_resource"]//div[@class="tabulator"]');
    ...
    ok(0 == scalar @{$browser->find_child_elements($table, './/div[@class="tabulator-cell"]')}, 'No network ressources, if no network is selected');
    # Select network 'Big'
    my $network_table = $browser->find_element('//div[@id="table_networks"]//div[@class="tabulator"]');
    ...
    ok($browser->download($browser->find_element('//div[@id="table_networks_resource"]//span[@class="material-icons" and text()="picture_as_pdf"]'), /\.pdf$/), 'Download ressources pdf');
    ok($browser->download($browser->find_element('//div[@id="table_networks_resource"]//span[@class="material-icons" and text()="border_all"]'), /\.xlsx$/), 'Download ressources xlsx');
}
